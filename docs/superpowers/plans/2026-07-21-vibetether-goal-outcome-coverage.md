...
- Commit `a71851e98a0b2c00130796a3370c6f5dd86771d2` and the results attributed to it in the companion delivery record are historical/non-current evidence for the earlier RC4 attempt.
