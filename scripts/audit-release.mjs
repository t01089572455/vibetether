...
const required=['README.md','CHANGELOG.md','CONTRIBUTING.md','SECURITY.md','THIRD_PARTY_NOTICES.md','LICENSE','docs/architecture/0001-lean-control-kernel.md','docs/design/VIBETETHER-BEGINNER-AND-CAPABILITY-CONTRACT.md','docs/design/VIBETETHER-COMPATIBILITY-AND-DATA-CONTRACT.md','docs/verification.md','skills/vibe-tether/SKILL.md','skills/vibe-tether-deep/SKILL.md','registry/community-provenance.json','.gitattributes','.github/workflows/ci.yml','scripts/test-live-v063-migration.mjs'];
